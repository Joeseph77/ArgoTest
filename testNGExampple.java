...
//                      to set implcit wait
    @BeforeMethod(alwaysRun = true)  //added so in xml we don't get NullPointerExcetipon" driver is null "
...
//    post-condition--> to  close the browser
    @AfterMethod(alwaysRun = true) //added so in xml we don't get NullPointerExcetipon" driver is null "
...
//    verofy login functionality
    @Test(groups = "regression") //tagging it
